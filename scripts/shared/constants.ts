/**
 * Shared constants used by all Bible extraction pipelines.
 */

import * as path from 'path';

/** Directory where generated Bible JSON files are stored. */
export const BIBLES_DIR = path.resolve(__dirname, '../../data/bibles');

/** English common names keyed by USFM code (for the commonName field in helloao JSON). */
...
/** USFM codes for deuterocanonical / apocryphal books. */
export const APOCRYPHAL_CODES = new Set([
